...
export const bestsellerBooks: Book[] = [
  {
    ...
    subtitle: 'Perspectivas críticas desde las ciencias sociales',
    ...
    category: 'Ciencias Sociales',
    collection: 'Estudios afrocolombianos',
    isBestseller: true,
    year: 2024,
    pages: 356,
    language: 'Español',
    sede: 'Sede Bogotá',
    isbnPrint: '978-958-794-350-0',
    keywords: ['racismo', 'discriminación', 'ciencias sociales', 'Colombia'],
    ratingAvg: 4.7,
    ratingCount: 31,
  },
  {
